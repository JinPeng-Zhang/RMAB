'''
对队列进行MDP建模，计算WITTLE INDEX值，reward采用20%、60%梯度变换，并加入动作
'''
import numpy as np
import math
queuenum = 8
...
pcome = [0.02534504,0.13369194+0.45,0.09386043,0.01754024,0.17004173,0.2459021,0.03012342,0.0451653]
...
for q in range(queuenum):
    ...
    R[q][STATE_MAX - 1][0] = -pcome[q]/0.0001
